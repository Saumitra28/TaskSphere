    ...
    return (
      <Link
        ...
        className={clsx(
          ...
          path === el.link.split("/")[0] ? "bg-[#2B2A4C] text-neutral-100" : ""
        )}
      >
        {el.icon}
    ...
    <div className='w-full  h-full flex flex-col gap-6 p-5'>
      <h1 className='flex gap-1 items-center'>
        <p className='bg-white p-2 rounded-full'>
          <MdOutlineAddTask className='text-[#100C08] text-2xl font-black' />
        </p>
      ...
      <div className=''>
        <button className='w-full flex gap-2 p-2 items-center text-lg text-[#fff]'>
          <MdSettings />
          <span>Settings</span>
        </button>
      </div>
