    ...
    <div>
      ...
      >
        <div className='relative mt-1'>
          <Listbox.Button className='relative w-full cursor-default rounded text-white bg-[#2B2A4C] pl-3 pr-10 text-left px-3 py-2.5 2xl:py-3 border border-gray-300 sm:text-sm'>
